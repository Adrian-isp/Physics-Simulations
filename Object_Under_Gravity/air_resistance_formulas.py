...
class Formulas:
    ...
    def drag_explain(self):
        ...
        self.make_plot()
        self.ax.text(0.5, 0.75, r"$\rho$ = air density", fontsize = 20, ha = 'center', va = 'center')
        self.ax.text(0.5, 0.5, r" $C_d$ = Coefficient of drag", fontsize = 20, ha = 'center', va = 'center')
        self.ax.text(0.5, 0.25, r"$A$ = Cross section area", fontsize = 20, ha = 'center', va = 'center')
